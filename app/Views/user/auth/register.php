                            ...
                            <div class="card-body">
                                <form method="post" action="/user/create">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="nama" type="text" class="form-control <?= isset($errors['nama']) ? 'is-invalid' : '' ?>" name="nama" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="nik" type="text" class="form-control <?= isset($errors['nik']) ? 'is-invalid' : '' ?>" name="nik">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="text" class="form-control <?= isset($errors['email']) ? 'is-invalid' : '' ?>" name="email">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="telepon" type="text" class="form-control <?= isset($errors['telepon']) ? 'is-invalid' : '' ?>" name="telepon">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="alamat" type="text" class="form-control <?= isset($errors['alamat']) ? 'is-invalid' : '' ?>" name="alamat">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password" type="password" class="form-control <?= isset($errors['password']) ? 'is-invalid' : '' ?>" name="password">
                                        <div class="invalid-feedback">
