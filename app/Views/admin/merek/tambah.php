    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="/admin/master/merek/tambah">Tambah</a></div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Form Tambah Data Merek</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    <form action="/admin/master/merek/insert" method="post">
                                        <?php $errors = validation_errors() ?>
                                        <?= csrf_field() ?>
                                        <div class="form-group">
                                            <label>Merek Mobil</label>
                                            <input type="text" class="form-control <?= isset($errors['nama_merek']) ? 'is-invalid' : '' ?>" placeholder="Masukkan Merek Mobil" name="nama_merek" id="nama_merek" value="<?= old('nama_merek') ?>">
