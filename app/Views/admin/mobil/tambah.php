    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="/admin/master/mobil/tambah">Tambah</a></div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="/admin/master/mobil/insert" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control <?= isset($errors['id_merek']) ? 'is-invalid' : '' ?>" name="id_merek" id="id_merek">
                                                ...
                                                <?php foreach ($merek as $key => $row) : ?>
                                                    <option value="<?= $row['id_merek'] ?>" <?= old('id_merek') == $row['id_merek'] ? 'selected' : '' ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control <?= isset($errors['nama_mobil']) ? 'is-invalid' : '' ?>" placeholder="Masukkan Nama Mobil" name="nama_mobil" id="nama_mobil" value="<?= old('nama_mobil') ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control <?= isset($errors['id_warna']) ? 'is-invalid' : '' ?>" name="id_warna" id="id_warna">
                                                ...
                                                <?php foreach ($warna as $key => $row) : ?>
                                                    <option value="<?= $row['id_warna'] ?>" <?= old('id_warna') == $row['id_warna'] ? 'selected' : '' ?>>
                                                        <?= $row['warna'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control <?= isset($errors['plat_nomor']) ? 'is-invalid' : '' ?>" placeholder="Masukkan Plat Nomor" name="plat_nomor" id="plat_nomor" value="<?= old('plat_nomor') ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            <label>Tahun</label>
                                            <input type="number" class="form-control <?= isset($errors['tahun']) ? 'is-invalid' : '' ?>" placeholder="Masukkan Tahun" name="tahun" id="tahun" value="<?= old('tahun') ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control <?= isset($errors['harga_sewa']) ? 'is-invalid' : '' ?>" placeholder="Masukkan Harga Sewa" name="harga_sewa" id="harga_sewa" value="<?= old('harga_sewa') ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label>Denda</label>
                                            <input type="number" class="form-control <?= isset($errors['denda']) ? 'is-invalid' : '' ?>" placeholder="Masukkan Denda" name="denda" id="denda" value="<?= old('denda') ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control <?= isset($errors['tersedia']) ? 'is-invalid' : '' ?>" name="tersedia" id="tersedia">
                                                ...
                                                <option value="Tersedia" <?= old('tersedia') == 'Tersedia' ? 'selected' : '' ?>>
                                                    Tersedia</option>
                                                <option value="Tidak Tersedia" <?= old('tersedia') == 'Tidak Tersedia' ? 'selected' : '' ?>>Tidak
                                                    Tersedia
                                                </option>
                                            </select>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control <?= isset($errors['fitur_ac']) ? 'is-invalid' : '' ?>" name="fitur_ac" id="fitur_ac">
                                                ...
                                                <option value="Ada" <?= old('fitur_ac') == 'Ada' ? 'selected' : '' ?>>
                                                    Ada</option>
                                                <option value="Tidak Ada" <?= old('fitur_ac') == 'Tidak Ada' ? 'selected' : '' ?>>Tidak Ada
                                                </option>
                                            </select>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control <?= isset($errors['fitur_tv']) ? 'is-invalid' : '' ?>" name="fitur_tv" id="fitur_tv">
                                                ...
                                                <option value="Ada" <?= old('fitur_tv') == 'Ada' ? 'selected' : '' ?>>
                                                    Ada</option>
                                                <option value="Tidak Ada" <?= old('fitur_tv') == 'Tidak Ada' ? 'selected' : '' ?>>Tidak
                                                    Ada
                                                </option>
                                            </select>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row justify-content-center p-3">
                                    <div class="col-4">
                                        <img src="<?= base_url('uploads') ?>/default.png" class="img-fluid rounded" alt="" id="gambar_preview">
                                    </div>
                                </div>
                            </div>
